...
import { PriceRingBuffer, type OpenClawPriceSnapshot } from "./openclawDecision";
...
export class Trade {
    ...
    /** Recent price snapshots used by the optional OpenClaw decision module. */
    openclawHistory!: PriceRingBuffer<OpenClawPriceSnapshot>;
    ...
    constructor(
        ...
        const lookback = globalThis.__CONFIG__?.openclaw?.lookback_points ?? 0;
        this.openclawHistory = new PriceRingBuffer<OpenClawPriceSnapshot>(lookback);
